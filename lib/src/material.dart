...
class Materials {
  ...
  static Material emerald = Material(
    ambient: Vector3(0.0215, 0.1745, 0.0215),
    diffuse: Vector3(0.07568, 0.61424, 0.07568),
    specular: Vector3(0.633, 0.727811, 0.633),
    shininess: 0.6,
  );
}
...
class Material {
  Material(
      ...
      double? shininess})
      : name = '',
        ambient = ambient ?? Vector3.all(0.1),
        diffuse = diffuse ?? Vector3.all(0.8),
        specular = specular ?? Vector3.all(0.5),
        ke = Vector3.zero(),
        tf = Vector3.zero(),
        mapKa = '',
        mapKd = '',
